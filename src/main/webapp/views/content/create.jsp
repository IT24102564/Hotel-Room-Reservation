...
<head>
    <meta charset="UTF-8">
    <title>Create Content - Luxe Hotel</title>
...
<header class="bg-white shadow-md">
    <div class="max-w-7xl mx-auto py-4 px-6 flex justify-between items-center">
        <h1 class="text-2xl font-bold text-purple-700">Create New Content</h1>
...
<main class="max-w-3xl mx-auto py-8 px-4 sm:px-6 lg:px-8">
    <div class="bg-white shadow-md rounded-lg p-6">
        <!-- Form -->
        <form id="createContentForm" class="space-y-6">
        ...
        <div id="successMessage" class="hidden mt-4 bg-green-100 border border-green-400 text-green-700 px-4 py-3 rounded relative" role="alert">
            <div class="flex">
                ...
                <div>
                    ...
                    <p class="text-sm">Content has been created successfully.</p>
                </div>
            </div>
        </div>
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        createContentForm.addEventListener('submit', async function(e) {
            e.preventDefault();
            ...
            try {
                ...
                const response = await fetch('${pageContext.request.contextPath}/content/', {
                    method: 'POST',
                    headers: {
                ...
                showErrorMessage(error.message || 'Failed to create content');
                hideLoading();
            }
        });
