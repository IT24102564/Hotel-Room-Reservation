...
<head>
    <meta charset="UTF-8">
    <title>Create Staff - Luxe Hotel</title>
...
<header class="bg-white shadow-md">
    <div class="max-w-7xl mx-auto py-4 px-6 flex justify-between items-center">
        <h1 class="text-2xl font-bold text-purple-700">Create New Staff</h1>
...
<main class="max-w-3xl mx-auto py-8 px-4 sm:px-6 lg:px-8">
    <div class="bg-white shadow-md rounded-lg p-6">
        <form id="createStaffForm" class="space-y-6">
        ...
        <div id="successMessage" class="hidden mt-4 bg-green-100 border border-green-400 text-green-700 px-4 py-3 rounded relative" role="alert">
            <div class="flex">
                ...
                <div>
                    ...
                    <p class="text-sm">Staff member has been created successfully.</p>
                </div>
            </div>
        </div>
    ...
    document.addEventListener('DOMContentLoaded', function () {
        ...
        form.addEventListener('submit', async function (e) {
            ...
            try {
                ...
                var response = await fetch('/hotel_war_exploded/staff/', {
                    method: 'POST',
                    headers: {
                ...
                console.log('Staff created successfully! Redirecting in 2 seconds...');
                ...
                errorText.textContent = error.message || 'There was an error creating the staff member.';
